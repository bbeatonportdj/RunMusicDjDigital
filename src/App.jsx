...
import { Zap, Home as HomeIcon, Headphones, Music, ShoppingCart, Gift, Package, Crown, Users, BookOpen, MessageSquare, ArrowRight, Search, LoaderCircle, Play, Disc3, Heart, Bookmark, LogIn, Sun, PanelLeft, Volume2, SkipBack, SkipForward, Repeat, Shuffle, LogOut, X, Clock, Trash2, Plus, Upload, CheckCircle2, Pause, RotateCcw } from 'lucide-react';
          ...
          <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-950 border-r border-blue-800/30 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-300 ease-in-out md:relative md:flex flex-col h-screen`}>
            ...
            <div className="p-6 border-t border-blue-800/30 bg-slate-950 text-center space-y-3">
              {session ? (
                ...
                <>
                  <p className="text-sm text-slate-300">Join our community to access exclusive features.</p>
                  <div className="flex items-center gap-2">
                    <button 
